...
Pal_SBZ3Cyc:	binclude	"palette/Cycle - SBZ3 Waterfall.bin";Pal_SBZ3Cyc1:	binclude	"palette\Cycle - SBZ3 Waterfall.bin"
...
ObjPos_Index:
		...
		dc.w ObjPos_SBZ1-ObjPos_Index, ObjPos_Null-ObjPos_Index
		zonewarning ObjPos_Index,$10;zonewarning ObjPos_Index,$10
		; Ending
