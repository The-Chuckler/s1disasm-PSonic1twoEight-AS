...
v_pal_water_dup	= ramaddr ( $FFFFFA00 );v_pal_water_dup:	equ $FFFFFA00 ; duplicate underwater palette, used for transitions ($80 bytes)
v_pal_water	= ramaddr ( $FFFFFA80 );v_pal_water:	equ $FFFFFA80	; main underwater palette ($80 bytes)
v_pal_dry	= ramaddr ( $FFFFFB00 );v_pal_dry:	equ $FFFFFB00	; main palette ($80 bytes)
v_pal_dry_dup	= ramaddr ( $FFFFFB80 );v_pal_dry_dup:	equ $FFFFFB80	; duplicate palette, used for transitions ($80 bytes)
